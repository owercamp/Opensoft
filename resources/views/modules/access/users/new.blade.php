...
<div class="col-md-12">
  <div class="row text-center border-bottom mb-4">
    ...
    <div class="col-md-4">
      <a href="{{ route('users') }}" class="btn btn-outline-tertiary mb-4 form-control-sm">VOLVER</a>
    </div>
  </div>
  <form action="{{ route('user.add') }}" method="PUT">
    ...
    <button type="submit" class="btn btn-outline-success form-control-sm">CREAR USUARIO</button>
  </form>
</div>
@endsection
