...
<div class="col-md-12 p-3">
  <div class="row border-bottom mb-3">
    ...
    <div class="col-md-4">
      <button type="button" title="Registrar un producto" class="btn btn-outline-success form-control-sm newProduct-link">NUEVO</button>
    </div>
    <div class="col-md-4">
  ...
  <table id="tableDatatable" class="table table-hover text-center" width="100%">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <a href="#" title="Editar producto {{ $product->ppName }}" class="btn btn-outline-primary rounded-circle form-control-sm editProduct-link">
            <i class="fas fa-edit"></i>
            <span hidden>{{ $product->ppId }}</span>
            <span hidden>{{ $product->ppName }}</span>
            <span hidden>{{ $product->ppDescription }}</span>
          </a>
          <a href="#" title="Eliminar producto {{ $product->ppName }}" class="btn btn-outline-tertiary rounded-circle form-control-sm deleteProduct-link">
