...
<div class="col-md-12 p-3">
  <div class="row border-bottom mb-3">
    ...
    <div class="col-md-4">
      <button type="button" title="Registrar un servicio" class="btn btn-outline-success form-control-sm newService-link">NUEVO</button>
    </div>
    <div class="col-md-4">
  ...
  <table id="tableDatatable" class="table table-hover text-center" width="100%">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <a href="#" title="Editar servicio {{ $service->psName }}" class="btn btn-outline-primary rounded-circle form-control-sm editService-link">
            <i class="fas fa-edit"></i>
            <span hidden>{{ $service->psId }}</span>
            <span hidden>{{ $service->psName }}</span>
            <span hidden>{{ $service->psDescription }}</span>
          </a>
          <a href="#" title="Eliminar servicio {{ $service->psName }}" class="btn btn-outline-tertiary rounded-circle form-control-sm deleteService-link">
