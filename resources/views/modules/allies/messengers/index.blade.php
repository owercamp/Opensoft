...
<div class="col-md-12 p-3">
  <div class="row border-bottom mb-3">
    ...
    <div class="col-md-4">
      <button type="button" title="Registrar mensajeria aliada" class="btn btn-outline-success form-control-sm newMessenger-link">NUEVO</button>
    </div>
    <div class="col-md-4">
  ...
  <table id="tableDatatable" class="table table-hover text-center" width="100%">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <a href="#" title="Editar mensajería aliada" class="btn btn-outline-primary rounded-circle form-control-sm editMessenger-link">
          ...
          <a href="#" title="Eliminar mensajería aliada" class="btn btn-outline-tertiary rounded-circle form-control-sm deleteMessenger-link">
      ...
      <div class="modal-body">
        <form action="{{ route('allies.messengers.save') }}" method="POST">
          ...
          <div class="form-group text-center">
            <button type="submit" class="btn btn-outline-success form-control-sm">REGISTRAR MENSAJERIA ALIADA</button>
          </div>
        </form>
      </div>
    </div>
