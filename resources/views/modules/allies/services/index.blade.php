...
@section('space')
	<div class="col-md-12 p-3">
		<div class="row border-bottom mb-3">
			...
			<div class="col-md-4">
				<button type="button" title="Registrar servicio especial aliado" class="bj-btn-table-add form-control-sm newEspecial-link">NUEVO</button>
			</div>
			<div class="col-md-4">
		...
		<table id="tableDatatable" class="table table-hover text-center" width="100%">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a href="#" title="Editar servicio especial aliado" class="bj-btn-table-edit form-control-sm editEspecial-link">
						...
						<a href="#" title="Eliminar servicio especial aliado" class="bj-btn-table-delete form-control-sm deleteEspecial-link">
				...
				<div class="modal-body">
					<form action="{{ route('allies.services.save') }}" method="POST">
						...
						<div class="form-group text-center">
							<button type="submit" class="bj-btn-table-add form-control-sm">REGISTRAR SERVICIO ESPECIAL ALIADO</button>
						</div>
					</form>
				</div>
			</div>
...
@section('scripts')
	<script>
		...
		$('.editEspecial-link').on('click',function(e){
			...
			$.get("{{ route('getMunicipalities') }}",{ depId: aeDepartment_id },function(objectMunicipalities){
				var count = Object.keys(objectMunicipalities).length;
				if(count > 0){
					for (var i = 0; i < count; i++) {
			...
			$.get("{{ route('getZonings') }}",{ munId: aeMunicipality_id },function(objectZonings){
				var count = Object.keys(objectZonings).length;
				if(count > 0){
					for (var i = 0; i < count; i++) {
			...
			$.get("{{ route('getNeighborhoods') }}",{ zonId: aeZoning_id },function(objectNeighborhoods){
