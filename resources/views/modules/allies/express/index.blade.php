...
@section('space')
	<div class="col-md-12 p-3">
		<div class="row border-bottom mb-3">
			...
			<div class="col-md-4">
				<button type="button" title="Registrar carga express aliada" class="bj-btn-table-add form-control-sm newCharge-link">NUEVO</button>
			</div>
			<div class="col-md-4">
		...
		<table id="tableDatatable" class="table table-hover text-center" width="100%">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a href="#" title="Editar carga express aliada" class="bj-btn-table-edit form-control-sm editCharge-link">
						...
						<a href="#" title="Eliminar carga express aliada" class="bj-btn-table-delete form-control-sm deleteCharge-link">
				...
				<div class="modal-body">
					<form action="{{ route('allies.express.save') }}" method="POST">
						...
						<div class="form-group text-center">
							<button type="submit" class="bj-btn-table-add form-control-sm">REGISTRAR CARGA EXPRESS ALIADA</button>
						</div>
					</form>
				</div>
			</div>
...
@section('scripts')
	<script>
		...
		$('.editCharge-link').on('click',function(e){
			...
			$.get("{{ route('getMunicipalities') }}",{ depId: acDepartment_id },function(objectMunicipalities){
				var count = Object.keys(objectMunicipalities).length;
				if(count > 0){
					for (var i = 0; i < count; i++) {
			...
			$.get("{{ route('getZonings') }}",{ munId: acMunicipality_id },function(objectZonings){
				var count = Object.keys(objectZonings).length;
				if(count > 0){
					for (var i = 0; i < count; i++) {
			...
			$.get("{{ route('getNeighborhoods') }}",{ zonId: acZoning_id },function(objectNeighborhoods){
