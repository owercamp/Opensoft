  ...
  <table id="tableDatatable" class="table table-bordered table-striped text-center w-100">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <button class="btn btn-outline-primary showEdit"><i class="fas fa-edit"></i><span hidden aria-hidden="true">{{$item->aca_id}}</span></button>
          <button class="btn btn-outline-danger mx-2 Delete-register"><i class="fas fa-eraser"></i><span hidden aria-hidden="true">{{$item->aca_id}}</span><span hidden aria-hidden="true">{{$row-1}}</span></button>
          <button class="btn btn-outline-secondary PDF-programs"><i class="far fa-file-pdf"></i><span hidden aria-hidden="true">{{$item->aca_id}}</span></button>
        </td>
      </tr>
      @endforeach
    </tbody>
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button class="btn btn-secondary rounded btn-close" role="button" data-dismiss="modal">&Xopf;</button>
      </div>
