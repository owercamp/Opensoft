...
<div class="col-md-12 p-3">
  <div class="row border-bottom mb-3">
    ...
    <div class="col-md-4">
      <button type="button" title="Registrar una entidad de riesgos laborales" class="btn btn-outline-success form-control-sm newRisk-link">NUEVO</button>
    </div>
    <div class="col-md-4">
  ...
  <table id="tableDatatable" class="table table-hover text-center" width="100%">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>{{ $risk->risName }}</td>
        <td>
          <a href="#" title="Editar entidad {{ $risk->risName }}" class="btn btn-outline-primary rounded-circle form-control-sm editRisk-link">
            <i class="fas fa-edit"></i>
            <span hidden>{{ $risk->risId }}</span>
            <span hidden>{{ $risk->risName }}</span>
          </a>
          <a href="#" title="Eliminar entidad {{ $risk->risName }}" class="btn btn-outline-tertiary rounded-circle form-control-sm deleteRisk-link">
