...
@section('space')
	<div class="col-md-12 p-3">
		<div class="row border-bottom mb-3">
			...
			<div class="col-md-4">
				<button type="button" title="Registrar un fondo de pensión" class="bj-btn-table-add form-control-sm newPension-link">NUEVO</button>
			</div>
			<div class="col-md-4">
		...
		<table id="tableDatatable" class="table table-hover text-center" width="100%">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a href="#" title="Editar fondo {{ $pension->heaName }}" class="bj-btn-table-edit form-control-sm editPension-link">
							<i class="fas fa-edit"></i>
							<span hidden>{{ $pension->penId }}</span>
							<span hidden>{{ $pension->penName }}</span>
						</a>
						<a href="#" title="Eliminar fondo {{ $pension->heaName }}" class="bj-btn-table-delete form-control-sm deletePension-link">
