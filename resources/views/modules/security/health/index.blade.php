...
@section('space')
	<div class="col-md-12 p-3">
		<div class="row border-bottom mb-3">
			...
			<div class="col-md-4">
				<button type="button" title="Registrar una entidad" class="bj-btn-table-add form-control-sm newHealth-link">NUEVO</button>
			</div>
			<div class="col-md-4">
		...
		<table id="tableDatatable" class="table table-hover text-center" width="100%">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a href="#" title="Editar entidad {{ $health->heaName }}" class="bj-btn-table-edit form-control-sm editHealth-link">
							<i class="fas fa-edit"></i>
							<span hidden>{{ $health->heaId }}</span>
							<span hidden>{{ $health->heaName }}</span>
						</a>
						<a href="#" title="Eliminar entidad {{ $health->heaName }}" class="bj-btn-table-delete form-control-sm deleteHealth-link">
