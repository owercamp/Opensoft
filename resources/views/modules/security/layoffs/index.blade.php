...
<div class="col-md-12 p-3">
  <div class="row border-bottom mb-3">
    ...
    <div class="col-md-4">
      <button type="button" title="Registrar un fondo de cesantias" class="btn btn-outline-success form-control-sm newLayoff-link">NUEVO</button>
    </div>
    <div class="col-md-4">
  ...
  <table id="tableDatatable" class="table table-hover text-center" width="100%">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <a href="#" title="Editar fondo {{ $layoff->layName }}" class="btn btn-outline-primary rounded-circle form-control-sm editLayoff-link">
            <i class="fas fa-edit"></i>
            <span hidden>{{ $layoff->layId }}</span>
            <span hidden>{{ $layoff->layName }}</span>
          </a>
          <a href="#" title="Eliminar fondo {{ $layoff->layName }}" class="btn btn-outline-tertiary rounded-circle form-control-sm deleteLayoff-link">
