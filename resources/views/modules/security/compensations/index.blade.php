...
@section('space')
	<div class="col-md-12 p-3">
		<div class="row border-bottom mb-3">
			...
			<div class="col-md-4">
				<button type="button" title="Registrar una caja de compensación" class="bj-btn-table-add form-control-sm newCompensation-link">NUEVO</button>
			</div>
			<div class="col-md-4">
		...
		<table id="tableDatatable" class="table table-hover text-center" width="100%">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a href="#" title="Editar caja de compensación {{ $compensation->comName }}" class="bj-btn-table-edit form-control-sm editCompensation-link">
							<i class="fas fa-edit"></i>
							<span hidden>{{ $compensation->comId }}</span>
							<span hidden>{{ $compensation->comName }}</span>
						</a>
						<a href="#" title="Eliminar caja de compensación {{ $compensation->comName }}" class="bj-btn-table-delete form-control-sm deleteCompensation-link">
