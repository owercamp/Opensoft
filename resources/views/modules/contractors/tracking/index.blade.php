...
<div class="col-md-12 p-3">
  <div class="row border-bottom mb-3">
    ...
    <div class="col-md-2">
      <button type="button" title="REGISTRAR" class="btn btn-outline-success form-control-sm newTracking-link">NUEVO</button>
    </div>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="d-flex justofy-content-center">
          <a href="#" title="EDITAR" class="btn btn-outline-primary rounded-circle form-control-sm editTracking-link">
          ...
          <a href="#" title="ELIMINAR" class="btn btn-outline-tertiary rounded-circle form-control-sm deleteTracking-link">
...
<script>
  ...
  $('select[name=tcDocument_id]').on('change', function(e) {
    ...
    if (selected != '') {
      ...
      $.get("{{ route('getNextcodeForTrackingcontractor') }}", {
        dolId: selected
