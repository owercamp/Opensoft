...
<div class="col-md-12 p-3">
  <div class="row border-bottom mb-3">
    ...
    <div class="col-md-4">
      <button type="button" title="Registrar" class="btn btn-outline-success form-control-sm newHandbook-link">NUEVO</button>
    </div>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="d-flex justofy-content-center">
          ...
          <a href="#" title="Editar" class="btn btn-outline-primary rounded-circle form-control-sm editHandbook-link">
          ...
          <a href="#" title="Eliminar" class="btn btn-outline-tertiary rounded-circle form-control-sm deleteHandbook-link">
...
<script>
  ...
  $('select[name=hcDocument_id]').on('change', function(e) {
    ...
    if (selected != '') {
      ...
      $.get("{{ route('getNextcodeFromDocument') }}", {
        dolId: selected
  ...
  $('select[name=hcDocument_id_Edit]').on('change', function(e) {
    ...
    if (selected != '') {
      ...
      if (selected == dolId) {
        ...
        $.get("{{ route('getNextcodeFromDocumentContractor') }}", {
          dolId: selected
        }, function(objectsNext) {
          if (objectsNext != null) {
