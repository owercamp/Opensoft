...
@section('space')
	<div class="col-md-12 p-3">
		<div class="row border-bottom mb-3">
			...
			<div class="col-md-2">
				<button type="button" title="Registrar" class="bj-btn-table-add form-control-sm newControl-link">NUEVO</button>
			</div>
			...
			<tbody>
				...
				<tr>
					...
					<td class="d-flex justofy-content-center">
						<a href="#" title="EDITAR" class="bj-btn-table-edit form-control-sm editControl-link">
						...
						<a href="#" title="ELIMINAR" class="bj-btn-table-delete form-control-sm deleteControl-link">
	...
	<script>
		...
		$('select[name=ascDocument_id]').on('change',function(e){
			...
			if(selected != ''){
				...
				$.get("{{ route('getNextcodeForControlcontractor') }}",{dolId: selected},function(objectsNext){
					if(objectsNext != null){
