...
@section('space')
	<div class="col-md-12 p-3">
		<div class="row border-bottom mb-3">
			...
			<div class="col-md-4">
				<button type="button" title="Registrar un departamento" class="bj-btn-table-add form-control-sm newDepartment-link">NUEVO</button>
			</div>
			<div class="col-md-4">
		...
		<table id="tableDatatable" class="table table-hover text-center" width="100%">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a href="#" title="Editar departamento {{ $department->depName }}" class="bj-btn-table-edit form-control-sm editDepartment-link">
							<i class="fas fa-edit"></i>
							<span hidden>{{ $department->depId }}</span>
							<span hidden>{{ $department->depName }}</span>
						</a>
						<a href="#" title="Eliminar departamento {{ $department->depName }}" class="bj-btn-table-delete form-control-sm deleteDepartment-link">
