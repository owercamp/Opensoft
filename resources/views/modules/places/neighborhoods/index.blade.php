...
<div class="col-md-12 p-3">
  <div class="row border-bottom mb-3">
    ...
    <div class="col-md-4">
      <button type="button" title="Registrar barrio" class="btn btn-outline-success form-control-sm newNeighborhood-link">NUEVO</button>
    </div>
    <div class="col-md-4">
  ...
  <table id="tableDatatable" class="table table-hover text-center" width="100%">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <a href="#" title="Editar barrio {{ $neighborhood->neName }}" class="btn btn-outline-primary rounded-circle form-control-sm editNeighborhood-link">
          ...
          <a href="#" title="Eliminar barrio {{ $neighborhood->neName }}" class="btn btn-outline-tertiary rounded-circle form-control-sm deleteNeighborhood-link">
