...
<div class="col-md-12 p-3">
  <div class="row border-bottom mb-3">
    ...
    <div class="col-md-4">
      <button type="button" title="Registrar zonificación" class="btn btn-outline-success form-control-sm newZoning-link">NUEVO</button>
    </div>
    <div class="col-md-4">
  ...
  <table id="tableDatatable" class="table table-hover text-center" width="100%">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <a href="#" title="Editar zona {{ $zoning->zonName }}" class="btn btn-outline-primary rounded-circle form-control-sm editZoning-link">
          ...
          <a href="#" title="Eliminar zona {{ $zoning->zonName }}" class="btn btn-outline-tertiary rounded-circle form-control-sm deleteZoning-link">
