...
@section('space')
	<div class="col-md-12 p-3">
		<div class="row border-bottom mb-3">
			...
			<div class="col-md-2">
				<button type="button" title="Registrar" class="bj-btn-table-add form-control-sm newEndowment-link">NUEVO</button>
			</div>
			...
			<tbody>
				...
				<tr>
					...
					<td class="d-flex justofy-content-center">
						<a href="#" title="Editar" class="bj-btn-table-edit form-control-sm editEndowment-link">
						...
						<a href="#" title="Eliminar" class="bj-btn-table-delete form-control-sm deleteEndowment-link">
	...
	<script>
		...
		$('select[name=ecoDocument_id]').on('change',function(e){
			...
			if(selected != ''){
				...
				$.get("{{ route('getNextcodeForEndowment') }}",{dolId: selected},function(objectsNext){
					if(objectsNext != null){
