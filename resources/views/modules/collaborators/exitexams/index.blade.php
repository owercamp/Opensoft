...
<div class="col-md-12 p-3">
  <div class="row border-bottom mb-3">
    ...
    <div class="col-md-2">
      <button type="button" title="Registrar" class="btn btn-outline-success form-control-sm newExit-link">NUEVO</button>
    </div>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="d-flex justofy-content-center">
          <a href="#" title="Editar" class="btn btn-outline-primary rounded-circle form-control-sm editExit-link">
          ...
          <a href="#" title="Eliminar" class="btn btn-outline-tertiary rounded-circle form-control-sm deleteExit-link">
...
<script>
  ...
  $('select[name=excDocument_id]').on('change', function(e) {
    ...
    if (selected != '') {
      ...
      $.get("{{ route('getNextcodeForExitexam') }}", {
        dolId: selected
