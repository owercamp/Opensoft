										...
										<div class="form-group">
											...
											<select name="npLegalization_id" class="form-control form-control-sm" required>
												...
												@foreach($legalizations as $legalization)
													<option value="{{ $legalization->bpId }}"
														data-names='{{ $legalization->proReasonsocial }}'
														data-type='{{ $legalization->perName }}'
														data-document='{{ $legalization->proNumberdocument }}'
														data-address='{{ $legalization->proAddress }}'
														data-email='{{ $legalization->proEmail }}'
														data-movil='{{ $legalization->proMovil }}'
														data-phone='{{ $legalization->proPhone }}'
														data-whatsapp='{{ $legalization->proWhatsapp }}'>
