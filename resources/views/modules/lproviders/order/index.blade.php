    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="d-flex justofy-content-center">
          ...
          <a href="#" title="ANULAR" class="btn btn-outline-tertiary rounded-circle form-control-sm nullOrder-link">
          ...
          <a href="#" title="CALIFICACION" class="btn btn-outline-success rounded-circle form-control-sm qualifyOrder-link">
      ...
      <div class="modal-body">
        <form action="{{ route('providers.order.save') }}" method="POST">
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <select name="orpBillprovider_id" class="form-control form-control-sm" required>
                      ...
                      <option value="{{ $provider->proId }}" data-names='{{ $provider->proReasonsocial }}' data-document='{{ $provider->proNumberdocument }}' data-address='{{ $provider->proAddress }}' data-phone='{{ $provider->proPhone }}' data-whatsapp='{{ $provider->proWhatsapp }}'>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <select name="orpProductservice" class="form-control form-control-sm" required>
                      <option value="">Seleccione ...</option>
                      @for($i = 0; $i < count($proser); $i++) <option value='{{ $proser[$i][0] }}' data-name='{{ $proser[$i][1] }}' data-type='{{ $proser[$i][2] }}'>
                ...
                <div class="col-md-6 pt-3">
                  <button type="button" class="btn btn-outline-success form-control-sm btn-add-newOrder">Agregar</button>
                </div>
              </div>
              <div class="row">
          ...
          <div class="form-group text-center pt-2 border-top">
            ...
            <button type="submit" class="btn btn-outline-success form-control-sm btn-save-newOrder">GUARDAR</button>
          </div>
        </form>
      </div>
    </div>
      ...
      <div class="modal-body">
        <form action="{{ route('providers.order.update') }}" method="POST">
          ...
          <div class="row">
            ...
            <div class="col-md-6 pt-3">
              <button type="button" class="btn btn-outline-success form-control-sm btn-add-editOrder">Agregar</button>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12 p-3 text-center">
          ...
          <div class="form-group text-center pt-2 border-top">
            ...
            <button type="submit" class="btn btn-outline-success form-control-sm btn-save-editOrder">GUARDAR CAMBIOS</button>
          </div>
        </form>
      </div>
    </div>
      ...
      <div class="modal-body">
        ...
        <form action="{{ route('providers.order.cancel') }}" method="POST">
          ...
          <div class="form-group text-center pt-2 border-top">
            ...
            <button type="submit" class="btn btn-outline-tertiary form-control-sm">ANULAR ORDEN</button>
          </div>
        </form>
      </div>
    </div>
      ...
      <div class="modal-body">
        ...
        <form action="{{ route('providers.order.qualify') }}" method="POST">
          ...
          <div class="form-group text-center pt-2 border-top">
            ...
            <button type="submit" class="btn btn-outline-tertiary form-control-sm">GUARDAR CALIFICACION</button>
          </div>
        </form>
      </div>
    </div>
    ...
    if (psId != '' && n != '' && t != '') {
      if (validateRepeat == false) {
        $('.tbl-orpOrders-newOrder tbody').append(
          ...
          "</td>" +
          "<td>" +
          "<button type='button' class='btn btn-outline-tertiary form-control-sm btn-deleteOrder' value='0' title='Eliminar orden'><i class='fas fa-trash-alt'></i></button>" +
          "</td>" +
          "</tr>"
        );
        validateTotal();
    ...
    if (find > -1) {
      ...
      for (var i = 0; i < separated.length; i++) {
        ...
        $('.tbl-orpOrders-editOrder tbody').append(
          ...
          "</td>" +
          "<td>" +
          "<button type='button' class='btn btn-outline-tertiary form-control-sm btn-deleteOrder_Edit' title='Eliminar orden'><i class='fas fa-trash-alt'></i></button>" +
          "</td>" +
          "</tr>"
        );
      }
