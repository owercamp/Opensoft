...
<div class="col-md-12 p-3">
  <div class="row border-bottom mb-3">
    ...
    <div class="col-md-4">
      <button type="button" title="Registrar" class="btn btn-outline-success form-control-sm newExpress-link">NUEVO</button>
    </div>
    <div class="col-md-4">
  ...
  <table id="tableDatatable" class="table table-hover text-center" width="100%">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <a href="#" title="Editar" class="btn btn-outline-primary rounded-circle form-control-sm editExpress-link">
          ...
          <a href="#" title="Eliminar" class="btn btn-outline-tertiary rounded-circle form-control-sm deleteExpress-link">
            ...
            <div class="col-md-12">
              ...
              <div class="row">
                ...
                <div class="col-md-6 text-center">
                  <button type="button" class="btn btn-outline-success form-control-sm mt-3 btn-addService-newExpress" title='AGREGUE EL SERVICIO SELECCIONADO PARA ESPECIFICAR VALORES'>Agregar servicio</button>
                </div>
              </div>
              <div class="row">
              ...
              <div class="row">
                <div class="col-md-12">
                  <table class="table table-hover text-center border-bottom tbl-service-newExpress" width="100%" style="font-size: 12px;">
                    <thead>
                      <th>SERVICIO</th>
                      <th>TARIFA BASE</th>
        ...
        <form action="{{ route('tariffs.logistic.update') }}" method="POST">
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="row">
                <div class="col-md-12">
                  <table class="table table-hover text-center border-bottom tbl-service-editExpress" width="100%" style="font-size: 12px;">
                    <thead>
                      <th>TARIFA BASE</th>
                      <th>VALOR MINUTO DE ESPERA</th>
                      <th>RECARGO IDA Y VUELTA</th>
    ...
    if (slId != '') {
      if (validateRepet == false) {
        $('.tbl-service-newExpress').find('tbody').append(
          ...
          "</td>" +
          "<td>" +
          "<button type='button' class='btn btn-outline-tertiary form-control-sm btn-deleteService-newExpress' title='Eliminar servicio'><i class='fas fa-trash-alt'></i></button>" +
          "</td>" +
          "</tr>"
        );
      } else {
