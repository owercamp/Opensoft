        ...
        <form action="{{ route('tariffs.transferintermunipality.save') }}" method="POST">
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="row">
                <div class="col-md-12">
                  <table class="table table-hover text-center border-bottom tbl-service-newTransfer" width="100%" style="font-size: 12px;">
                    <thead>
                      <th>SERVICIO</th>
                      <th>PRODUCTO</th>
        ...
        <form action="{{ route('tariffs.transferintermunipality.update') }}" method="POST">
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="row">
                <div class="col-md-12">
                  <table class="table table-hover text-center border-bottom tbl-service-editTransfer" width="100%" style="font-size: 12px;">
                    <thead>
                      <th>TARIFA BASE</th>
                    </thead>
                    <tbody>
