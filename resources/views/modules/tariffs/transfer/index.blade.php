...
@section('space')
	<div class="col-md-12 p-3">
		<div class="row border-bottom mb-3">
			...
			<div class="col-md-4">
				<button type="button" title="Registrar" class="bj-btn-table-add form-control-sm newTransfer-link">NUEVO</button>
			</div>
			<div class="col-md-4">
		...
		<table id="tableDatatable" class="table table-hover text-center" width="100%">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a href="#" title="Editar" class="bj-btn-table-edit form-control-sm editTransfer-link">
						...
						<a href="#" title="Eliminar" class="bj-btn-table-delete form-control-sm deleteTransfer-link">
							...
							<div class="col-md-12">
								...
								<div class="row">
									<div class="col-md-12 p-3 text-center">
										<button type="button" class="bj-btn-table-add form-control-sm mt-3 btn-addService-newTransfer" title='AGREGUE EL SERVICIO SELECCIONADO PARA ESPECIFICAR VALORES'>Agregar servicio</button>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12 p-3 text-center">
				...
				if(validateRepet == false){
					$('.tbl-service-newTransfer').find('tbody').append(
						"<tr class='" + strId + "' data-idService='" + strId + "'>" +
							...
							"</td>" +
							"<td>" +
								"<button type='button' class='bj-btn-table-delete form-control-sm btn-deleteService-newTransfer' title='Eliminar servicio'><i class='fas fa-trash-alt'></i></button>" +
							"</td>" +
						"</tr>"
					);
				}else{
