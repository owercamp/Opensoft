  ...
  <table id="tableDatatable" class="table table-hover text-center" width="100%">
    ...
    <tbody>
      ...
      <tr>
        ...
        @endif
        <td>
          <a href="#" title="Editar carga express {{ $charge->pcProduct }}" class="btn btn-outline-primary rounded-circle form-control-sm editExpress-link">
            <i class="fas fa-edit"></i>
            <span hidden>{{ $charge->pcId }}</span>
            <span hidden>{{ $charge->pcProduct }}</span>
            <span hidden>{{ $charge->pcDescription }}</span>
          </a>
          <a href="#" title="Eliminar carga express {{ $charge->pcProduct }}" class="btn btn-outline-tertiary rounded-circle form-control-sm deleteExpress-link">
