  ...
  <table id="tableDatatable" class="table table-hover text-center" width="100%">
    ...
    <tbody>
      ...
      <tr>
        ...
        @endif
        <td>
          <a href="#" title="Editar traslado {{ $transfer->ptrProduct }}" class="btn btn-outline-primary rounded-circle form-control-sm editTransfer-link">
          ...
          <a href="#" title="Eliminar traslado {{ $transfer->ptrProduct }}" class="btn btn-outline-tertiary rounded-circle form-control-sm deleteTransfer-link">
