  ...
  <table id="tableDatatable" class="table table-hover text-center" width="100%">
    ...
    <tbody>
      ...
      <tr>
        ...
        @endif
        <td>
          <a href="#" title="Editar logística {{ $logistic->plProduct }}" class="btn btn-outline-primary rounded-circle form-control-sm editLogistic-link">
            <i class="fas fa-edit"></i>
            <span hidden>{{ $logistic->plId }}</span>
            <span hidden>{{ $logistic->plProduct }}</span>
            <span hidden>{{ $logistic->plDescription }}</span>
          </a>
          <a href="#" title="Eliminar logística {{ $logistic->plProduct }}" class="btn btn-outline-tertiary rounded-circle form-control-sm deleteLogistic-link">
