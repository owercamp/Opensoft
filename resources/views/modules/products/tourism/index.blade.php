		...
		<table id="tableDatatable" class="table table-hover text-center" width="100%">
			...
			<tbody>
				...
				<tr>
					...
					@endif
					<td>
						<a href="#" title="Editar turismo {{ $tourism->ptProduct }}" class="bj-btn-table-edit form-control-sm editTurism-link">
						...
						<a href="#" title="Eliminar turismo {{ $tourism->ptProduct }}" class="bj-btn-table-delete form-control-sm deleteTurism-link">
