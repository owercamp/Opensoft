  ...
  <table id="tableDatatable" class="table table-hover text-center" width="100%">
    ...
    <tbody>
      ...
      <tr>
        ...
        @endif
        <td>
          <a href="#" title="Editar traslado {{ $transfer->ptmProduct }}" class="btn btn-outline-primary rounded-circle form-control-sm editTransfer-link">
            <i class="fas fa-edit"></i>
            <span hidden>{{ $transfer->ptmId }}</span>
            <span hidden>{{ $transfer->ptmProduct }}</span>
            <span hidden>{{ $transfer->ptmDescription }}</span>
          </a>
          <a href="#" title="Eliminar traslado {{ $transfer->ptmProduct }}" class="btn btn-outline-tertiary rounded-circle form-control-sm deleteTransfer-link">
