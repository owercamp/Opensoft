...
@section('space')
	<div class="col-md-12 p-3">
		<div class="row border-bottom mb-3">
			...
			<div class="col-md-4">
				<button type="button" title="Registrar una licencia de conducción" class="bj-btn-table-add form-control-sm newDriving-link">NUEVO</button>
			</div>
			<div class="col-md-4">
		...
		<table id="tableDatatable" class="table table-hover text-center" width="100%">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a href="#" title="Editar licencia {{ $driving->perName }}" class="bj-btn-table-edit form-control-sm editDriving-link">
						...
						<a href="#" title="Eliminar licencia {{ $driving->perName }}" class="bj-btn-table-delete form-control-sm deleteDriving-link">
