...
<div class="col-md-12 p-3">
  <div class="row border-bottom mb-3">
    ...
    <div class="col-md-4">
      <button type="button" title="Registrar una poliza/seguro" class="btn btn-outline-success form-control-sm newInsurance-link">NUEVO</button>
    </div>
    <div class="col-md-4">
  ...
  <table id="tableDatatable" class="table table-hover text-center" width="100%">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <a href="#" title="Editar poliza/seguro {{ $insurance->insName }}" class="btn btn-outline-primary rounded-circle form-control-sm editInsurance-link">
            <i class="fas fa-edit"></i>
            <span hidden>{{ $insurance->insId }}</span>
            <span hidden>{{ $insurance->insName }}</span>
            <span hidden>{{ $insurance->insDescription }}</span>
          </a>
          <a href="#" title="Eliminar poliza/seguro {{ $insurance->insName }}" class="btn btn-outline-tertiary rounded-circle form-control-sm deleteInsurance-link">
