...
<div class="col-md-12 p-3">
  <div class="row border-bottom mb-3">
    ...
    <div class="col-md-4">
      <button type="button" title="Registrar una identificación personal" class="btn btn-outline-success form-control-sm newPersonal-link">NUEVO</button>
    </div>
    <div class="col-md-4">
  ...
  <table id="tableDatatable" class="table table-hover text-center" width="100%">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <a href="#" title="Editar departamento {{ $personal->perName }}" class="btn btn-outline-primary rounded-circle form-control-sm editPersonal-link">
            <i class="fas fa-edit"></i>
            <span hidden>{{ $personal->perId }}</span>
            <span hidden>{{ $personal->perName }}</span>
          </a>
          <a href="#" title="Eliminar departamento {{ $personal->perName }}" class="btn btn-outline-tertiary rounded-circle form-control-sm deletePersonal-link">
