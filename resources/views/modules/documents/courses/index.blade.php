...
@section('space')
	<div class="col-md-12 p-3">
		<div class="row border-bottom mb-3">
			...
			<div class="col-md-4">
				<button type="button" title="Registrar un curso" class="bj-btn-table-add form-control-sm newCourse-link">NUEVO</button>
			</div>
			<div class="col-md-4">
		...
		<table id="tableDatatable" class="table table-hover text-center" width="100%">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a href="#" title="Editar curso {{ $course->couName }}" class="bj-btn-table-edit form-control-sm editCourse-link">
						...
						<a href="#" title="Eliminar curso {{ $course->couName }}" class="bj-btn-table-delete form-control-sm deleteCourse-link">
