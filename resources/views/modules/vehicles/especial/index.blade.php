...
<div class="col-md-12 p-3">
  <div class="row border-bottom mb-3">
    ...
    <div class="col-md-4">
      <button type="button" title="Registrar un vehiculo especial" class="btn btn-outline-success form-control-sm newEspecial-link">NUEVO</button>
    </div>
    <div class="col-md-4">
  ...
  <table id="tableDatatable" class="table table-hover text-center" width="100%">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <a href="#" title="Editar especial {{ $especial->espTypology }}" class="btn btn-outline-primary rounded-circle form-control-sm editEspecial-link">
          ...
          <a href="#" title="Eliminar especial {{ $especial->espTypology }}" class="btn btn-outline-tertiary rounded-circle form-control-sm deleteEspecial-link">
