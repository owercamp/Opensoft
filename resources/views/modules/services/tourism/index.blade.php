...
@section('space')
	<div class="col-md-12 p-3">
		<div class="row border-bottom mb-3">
			...
			<div class="col-md-4">
				<button type="button" title="Registrar turismo" class="bj-btn-table-add form-control-sm newTurism-link">NUEVO</button>
			</div>
			<div class="col-md-4">
		...
		<table id="tableDatatable" class="table table-hover text-center" width="100%">
			...
			<tbody>
				...
				<tr>
					...
					@endif
					<td>
						<a href="#" title="Editar turismo {{ $tourism->stService }}" class="bj-btn-table-edit form-control-sm editTurism-link">
						...
						<a href="#" title="Eliminar turismo {{ $tourism->stService }}" class="bj-btn-table-delete form-control-sm deleteTurism-link">
