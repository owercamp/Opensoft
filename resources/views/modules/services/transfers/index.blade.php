		...
		<table id="tableDatatable" class="table table-hover text-center" width="100%">
			...
			<tbody>
				...
				<tr>
					...
					@endif
					<td>
						<a href="#" title="Editar traslado {{ $transfer->strService }}" class="bj-btn-table-edit form-control-sm editTransfer-link">
						...
						<a href="#" title="Eliminar traslado {{ $transfer->strService }}" class="bj-btn-table-delete form-control-sm deleteTransfer-link">
