  ...
  <table id="tableDatatable" class="table table-hover text-center" width="100%">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <a href="#" title="Editar traslado {{ $transfer->stmService }}" class="btn btn-outline-primary rounded-circle form-control-sm editTransfer-link">
          ...
          <a href="#" title="Eliminar traslado {{ $transfer->stmService }}" class="btn btn-outline-tertiary rounded-circle form-control-sm deleteTransfer-link">
            ...
            <div class="col-md-12">
              ...
              <div class="row">
                ...
                <div class="col-md-6 text-center">
                  <button type="button" class="btn btn-outline-success form-control-sm mt-3 btn-addDestiny-newTransfermunicipality" title='AGREGUE DESTINOS'>Agregar destino</button>
                </div>
              </div>
              <div class="row">
        ...
        <form action="{{ route('services.transfersmunicipals.update') }}" method="POST">
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="row">
                ...
                <div class="col-md-6 text-center">
                  <button type="button" class="btn btn-outline-success form-control-sm mt-3 btn-addDestiny-editTransfermunicipality" title='AGREGUE DESTINOS'>Agregar destino</button>
                </div>
              </div>
              <div class="row">
                <div class="col-md-12 p-3 text-center">
          ...
          <div class="row border-top mt-3 text-center">
            <div class="col-md-6">
              ...
              <button type="submit" class="btn btn-outline-success form-control-sm my-3 btn-editDefinitive">GUARDAR CAMBIOS</button>
            </div>
            <div class="col-md-6">
...
<script>
    ...
    if (munId != '') {
      if (validateRepet == false) {
        $('.tbl-destiny-newTransfermunicipality').find('tbody').append(
          ...
          "<td>" + munName + "</td>" +
          "<td>" +
          "<button type='button' class='btn btn-outline-tertiary form-control-sm btn-deleteDestiny-newTransfermunicipality'><i class='fas fa-trash-alt'></i></button>" +
          "</td>" +
          "</tr>"
        );
      } else {
  ...
  $('.editTransfer-link').on('click', function(e) {
    ...
    if (find > -1) {
      ...
      $.get("{{ route('getMunicipalitiesFromTransfer') }}", {
        munId: separated,
        unique: false
        ...
        if (count > 0) {
          for (var i = 0; i < count; i++) {
            $('.tbl-destiny-editTransfermunicipality').find('tbody').append(
              ...
              "<td>" +
              "<button type='button' class='btn btn-outline-tertiary form-control-sm btn-deleteDestiny-editTransfermunicipality'><i class='fas fa-trash-alt'></i></button>" +
              "</td>" +
              "</tr>"
            );
          }
