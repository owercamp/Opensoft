		...
		<table id="tableDatatable" class="table table-hover text-center" width="100%">
			...
			<tbody>
				...
				<tr>
					...
					@endif
					<td>
						<a href="#" title="Editar logística {{ $logistic->slService }}" class="bj-btn-table-edit form-control-sm editLogistic-link">
						...
						<a href="#" title="Eliminar logística {{ $logistic->slService }}" class="bj-btn-table-delete form-control-sm deleteLogistic-link">
