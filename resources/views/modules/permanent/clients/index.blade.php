...
<div class="col-md-12 p-3">
  <div class="row border-bottom mb-3">
    ...
    <div class="col-md-4">
      <button type="button" title="Registrar" class="btn btn-outline-success form-control-sm newClient-link">NUEVO</button>
    </div>
    <div class="col-md-4">
  ...
  <table id="tableDatatable" class="table table-hover text-center" width="100%">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          @if($client->cliType == 'Natural')
          <a href="#" title="Editar persona natural" class="btn btn-outline-primary rounded-circle form-control-sm editClientnatural-link">
          ...
          <a href="#" title="Eliminar persona natural" class="btn btn-outline-tertiary rounded-circle form-control-sm deleteClientnatural-link">
          ...
          @else
          <a href="#" title="Editar persona jurídica" class="btn btn-outline-primary rounded-circle form-control-sm editClientjuridica-link">
            <i class="fas fa-edit"></i>
            <span hidden>{{ $client->cliId }}</span>
            <span hidden>{{ $client->cliNamereason }}</span>
            <span hidden>{{ $client->cliNumberdocument }}</span>
          ...
          <a href="#" title="Eliminar persona jurídica" class="btn btn-outline-tertiary rounded-circle form-control-sm deleteClientjuridica-link">
            <i class="fas fa-trash-alt"></i>
            <span hidden>{{ $client->cliId }}</span>
            <span hidden>{{ $client->cliNamereason }}</span>
            <span hidden>{{ $client->cliNumberdocument }}</span>
