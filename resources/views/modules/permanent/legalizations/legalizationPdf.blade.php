        ...
        <header id="header">
            <table class="border" width="100%" style="text-align: center;">
                <tr>
                    ...
                    <td class="border">{{ $legalization->configdocument->document->docCode }}</td>
                </tr>
                <tr>
                    <td class="border">Versión</td>
                    <td class="border">{{ $legalization->configdocument->document->docVersion }}</td>
                </tr>
                <tr>
                    <td class="border" rowspan="2">
                        {{ $legalization->configdocument->document->docName }}                 
                    </td>
