...
<div class="col-md-12 p-3">
  <div class="row border-bottom mb-3">
    ...
    <div class="col-md-4">
      <button type="button" title="Registrar" class="btn btn-outline-success form-control-sm newTerm-link">NUEVO</button>
    </div>
    <div class="col-md-4">
  ...
  <table id="tableDatatable" class="table table-hover text-center" width="100%" style="font-size: 12px;">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <a href="#" title="Editar" class="btn btn-outline-primary rounded-circle form-control-sm editTerm-link">
          ...
          <a href="#" title="Eliminar" class="btn btn-outline-tertiary rounded-circle form-control-sm deleteTerm-link">
          ...
          <form action="{{ route('permanent.conditions.pdf') }}" style="display: inline;">
            ...
            <button type="submit" title="Descargar PDF" class="btn btn-outline-tertiary rounded-circle form-control-sm downloadTerm-link">
                ...
                <div class="col-md-12">
                  ...
                  <div class="row">
                    <div class="col-md-12 text-center">
                      <button type="button" class="btn btn-outline-success form-control-sm btn-briefcase-addTerm">Agregar</button>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <form action="{{ route('permanent.conditions.update') }}" method="POST">
            ...
            <div class="col-md-12">
              ...
              <div class="row border mx-3 p-2">
                <div class="col-md-12">
                  ...
                  <div class="row">
                    <div class="col-md-12 text-center">
                      <button type="button" class="btn btn-outline-success form-control-sm btn-briefcase-addTerm-edit">Agregar</button>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="row border-top mt-3 text-center">
            <div class="col-md-6">
              ...
              <button type="submit" class="btn btn-outline-success form-control-sm my-3 btn-updateDefinitive">GUARDAR CAMBIOS</button>
            </div>
            <div class="col-md-6">
    ...
    if (find > -1) {
      ...
      for (var i = 0; i < separatedBriefcases.length; i++) {
        ...
        $('.tbl-briefcase-terms-edit').find('tbody').append(
          ...
          "</td>" +
          "<td>" +
          "<button type='button' class='btn btn-outline-tertiary form-control-sm btn-deleteBriefcase-edit' title='Eliminar portafolio'><i class='fas fa-trash-alt'></i></button>" +
          "</td>" +
          "</tr>"
        );
