...
<div class="col-md-12 p-3">
  <div class="row border-bottom mb-3">
    <div class="col-md-4">
      <h5 id="titleSection">CONTRATISTAS CARGA EXPRESS</h5>
    </div>
    <div class="col-md-4">
  ...
  <table id="tableDatatable" class="table table-hover text-center" width="100%">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <button href="#" title="Editar contratista {{ ucwords($contractor->ccNames) }}" class="btn btn-outline-primary rounded-circle editContractor-link">
          ...
          <button href="#" title="Eliminar contratista {{ ucwords($contractor->ccNames) }}" class="btn btn-outline-tertiary rounded-circle deleteContractor-link">
          ...
          <button class="btn btn-outline-info rounded-circle Interview" title="{{'Entrevista '.ucwords($contractor->ccNames)}}"><i class="fas fa-clipboard"></i>
            <span hidden>{{ $contractor->ccNames }}</span>
            <span hidden>{{ $contractor->ccId }}</span>
          </button>
          <button class="btn btn-outline-secondary rounded-circle References" title="{{'Referencias '.ucwords($contractor->ccNames)}}"><i class="far fa-eye"></i>
            <span hidden>{{ $contractor->ccNames }}</span>
            <span hidden>{{ $contractor->ccId }}</span>
          </button>
          <button class="btn btn-outline-tertiary rounded-circle CV" title="{{'Hoja de Vida '.ucwords($contractor->ccNames)}}"><i class="fas fa-award"></i><span hidden>{{ $contractor->ccId}}</span></button>
        </td>
      </tr>
      @endforeach
    </tbody>
