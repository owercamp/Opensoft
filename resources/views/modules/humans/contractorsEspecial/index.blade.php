...
@section('space')
	<div class="col-md-12 p-3">
		<div class="row border-bottom mb-3">
			...
			<div class="col-md-4">
				<button type="button" title="Registrar contratista de servicio especial" class="bj-btn-table-add form-control-sm newContractor-link">NUEVO</button>
			</div>
			<div class="col-md-4">
		...
		<table id="tableDatatable" class="table table-hover text-center" width="100%">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a href="#" title="Editar contratista {{ $contractor->ceNames }}" class="bj-btn-table-edit form-control-sm editContractor-link">
						...
						<a href="#" title="Eliminar contratista {{ $contractor->ceNames }}" class="bj-btn-table-delete form-control-sm deleteContractor-link">
...
@section('scripts')
	<script>
		...
		$('.editContractor-link').on('click',function(e){
			...
			$.get("{{ route('getCourses') }}",{ ids: ceCourses },function(objectCourses){
