...
<div class="col-md-12 p-3">
    ...
    <div class="col-md-12">
      <div class="row">
        <div class="col-md-12">
            ...
            <div class="col-md-6">
              ...
              <span class="text-muted">
                <b class="leRepresentativepersonal_id_info">
                  N°
                  <!-- {{ $legal->leRepresentativepersonal_id }} -->
                </b>
          ...
          <div class="row p-4">
            <div class="col-md-6">
              <a href="#" title="Eliminar información" class="btn btn-outline-tertiary form-control-sm deleteLegal-link">
            ...
            <div class="col-md-6">
              <a href="#" title="Editar información" class="btn btn-outline-primary form-control-sm editLegal-link">
  ...
  <div class="row">
    <div class="col-md-12 text-center">
      ...
      <br>
      <button type="button" title="Registrar información jurídica" class="btn btn-outline-success form-control-sm newLegal-link">GUARDAR INFORMACION</button>
    </div>
  </div>
  @endif
</div>
