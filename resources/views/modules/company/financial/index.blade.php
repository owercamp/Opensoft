				...
				<div class="col-md-12">
					<div class="row">
						<div class="col-md-12">
							...
							<div class="row p-4">
								<div class="col-md-6">
									<a href="#" title="Eliminar información" class="bj-btn-table-delete form-control-sm deleteFinancial-link">
								...
								<div class="col-md-6">
									<a href="#" title="Editar información" class="bj-btn-table-edit form-control-sm editFinancial-link">
		...
		@else
			<div class="row">
				<div class="col-md-12 text-center">
					...
					<br>
					<button type="button" title="Registrar información financiera" class="bj-btn-table-add form-control-sm newfinancial-link">GUARDAR INFORMACION</button>
				</div>
			</div>
		@endif
	</div>
