...
<div class="col-md-12 p-3">
      ...
      <div class="row">
        <div class="col-md-12">
              ...
              <tr>
                <td colspan="3">
                  <table class="table border text-center" width="100%">
                    ...
                    <tbody>
                      @for($c = 0; $c < count($certifications); $c++) <tr>
          ...
          <tr>
            ...
            <div class="row p-4">
              <div class="col-md-6">
                <a href="#" title="Eliminar información" class="btn btn-outline-tertiary form-control-sm deleteTechnical-link">
              ...
              <div class="col-md-6">
                <a href="#" title="Editar información" class="btn btn-outline-primary form-control-sm editTechnical-link">
  ...
  <div class="row">
    <div class="col-md-12 text-center">
      ...
      <br>
      <button type="button" title="Registrar información técnica" class="btn btn-outline-success form-control-sm newTechnical-link">REGISTRAR INFORMACION</button>
    </div>
  </div>
  @endif
</div>
      ...
      <div class="modal-body">
        <form action="{{ route('technical.save') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-md-12">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4 text-center">
                      <button type="button" class="btn btn-outline-success form-control-sm mt-3 btn-addCertificated-newTechnical" title='AGREGUE CERTIFICADOS'>Agregar certificado</button>
                    </div>
          ...
          <div class="form-group text-center pt-2 border-top">
            ...
            <button type="submit" class="btn btn-outline-success form-control-sm btn-newDefinitiveTechnical">GUARDAR</button>
          </div>
        </form>
      </div>
    </div>
      ...
      <div class="modal-body">
        <form action="{{ route('technical.update') }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="row m-3 p-3 border">
                <div class="col-md-12">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4 text-center">
                      <button type="button" class="btn btn-outline-success form-control-sm mt-3 btn-addCertificated-editTechnical" title='AGREGUE CERTIFICADOS'>Agregar certificado</button>
                    </div>
                    <div class="col-md-4 p-3 text-center">
          ...
          <div class="form-group text-center pt-2 border-top">
            ...
            <button type="submit" class="btn btn-outline-success form-control-sm btn-updateDefinitiveTechnical">GUARDAR CAMBIOS</button>
          </div>
        </form>
      </div>
    </div>
    ...
    if (newCertificated != '') {
      if (validateRepet == false) {
        $('.tbl-certificated-newTechnical').find('tbody').append(
          ...
          "<td>" +
          "<button type='button' class='btn btn-outline-tertiary form-control-sm btn-deleteCertificated-newTechnical'><i class='fas fa-trash-alt'></i></button>" +
          "</td>" +
          "</tr>"
        );
      } else {
    ...
    if (find > -1) {
      ...
      for (var i = 0; i < separatedCertifications.length; i++) {
        $('.tbl-certificated-editTechnical').find('tbody').append(
          ...
          "<td>" +
          "<button type='button' class='btn btn-outline-tertiary form-control-sm btn-deleteCertificated-editTechnical'><i class='fas fa-trash-alt'></i></button>" +
          "</td>" +
          "</tr>"
        );
      }
