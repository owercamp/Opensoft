  ...
  <table id="tableDatatable" class="table table-hover text-center" width="100%">
    ...
    <tbody>
      @for($i=0; $i < count($dates); $i++) <tr>
        ...
        <td>{{ $dates[$i][8] }}</td>
        <td>
          <a href="#" title="Bitacora de seguimiento" class="btn btn-outline-primary rounded-circle form-control-sm binnacleBidding-link">
        ...
        <td>{{ $dates[$i][8] }}</td>
        <td>
          <a href="#" title="Bitacora de seguimiento" class="btn btn-outline-primary rounded-circle form-control-sm binnacleProposal-link">
            <i class="fas fa-eye"></i>
            <span hidden>{{ $dates[$i][2] }}</span>
            <span hidden>{{ $dates[$i][3] }}</span>
            <span hidden>{{ $dates[$i][4] }}</span>
            ...
            <form action="{{ route('clients.tracking.save') }}" method="POST">
              ...
              <div class="row">
                <div class="col-md-12 text-center">
                  ...
                  <button type="submit" class="btn btn-outline-success form-control-sm my-3">AGREGAR SEGUIMIENTO</button>
                </div>
              </div>
            </form>
          </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <form action="{{ route('clients.bidding.no') }}" class="text-center" method="POST">
                  ...
                  <button type="submit" class="btn btn-outline-tertiary form-control-sm my-3">RECHAZADO</button>
                </form>
              </div>
              <div class="col-md-6">
                <form action="{{ route('clients.bidding.yes') }}" class="text-center" method="POST">
                  ...
                  <button type="submit" class="btn btn-outline-success form-control-sm my-3">ACEPTADO</button>
                </form>
              </div>
            </div>
          </div>
