...
<div class="col-md-12 p-3">
  <div class="row border-bottom mb-3">
    ...
    <div class="col-md-4">
      <button type="button" title="Registrar mensajeria automotor" class="btn btn-outline-success form-control-sm newMessenger-link">NUEVO</button>
    </div>
    <div class="col-md-4">
  ...
  <table id="tableDatatable" class="table table-hover text-center" width="100%">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <a href="#" title="Editar mensajería automotor" class="btn btn-outline-primary rounded-circle form-control-sm editMessenger-link">
          ...
          <a href="#" title="Eliminar mensajería automotor" class="btn btn-outline-tertiary rounded-circle form-control-sm deleteMessenger-link">
      ...
      <div class="modal-body">
        <form action="{{ route('automotors.messengers.save') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-md-12">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4 text-center">
                      <button type="button" class="btn btn-outline-success form-control-sm mt-3 btn-addDriver-newMessenger" title='AGREGUE CONDUCTOR OPERADOR'>Agregar conductor</button>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <table class="table table-hover text-center tbl-drivers-newMessenger" width="100%" style="font-size: 12px;">
                        <thead>
                          <th>NOMBRE</th>
                          <th>DOCUMENTO</th>
                          <th>LICENCIA</th>
          ...
          <div class="form-group text-center">
            ...
            <button type="submit" class="btn btn-outline-success form-control-sm btn-newDefinitiveMessenger">REGISTRAR AUTOMOTOR</button>
          </div>
        </form>
      </div>
    </div>
        ...
        <form action="{{ route('automotors.messengers.update') }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="row m-2 p-2 border">
                <div class="col-md-12">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4 text-center">
                      <button type="button" class="btn btn-outline-success form-control-sm mt-3 btn-addDriver-editMessenger" title='AGREGUE CONDUCTOR OPERADOR'>Agregar conductor</button>
                    </div>
                    <div class="col-md-4 p-3 text-center">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <table class="table table-hover text-center tbl-drivers-editMessenger" width="100%" style="font-size: 12px;">
                        <thead>
                          <th>NOMBRE</th>
                          <th>DOCUMENTO</th>
                          <th>LICENCIA</th>
          ...
          <div class="row border-top mt-3 text-center">
            <div class="col-md-6">
              ...
              <button type="submit" class="btn btn-outline-success form-control-sm my-3 btn-editDefinitiveMessenger">GUARDAR CAMBIOS</button>
            </div>
            <div class="col-md-6">
...
<script>
    ...
    if (cmId != '') {
      ...
      if (validateRepet == false) {
        $('.tbl-drivers-newMessenger').find('tbody').append(
          ...
          "<td>" +
          "<button type='button' class='btn btn-outline-tertiary form-control-sm btn-deleteDriver-newMessenger'><i class='fas fa-trash-alt'></i></button>" +
          "</td>" +
          "</tr>"
        );
      } else {
  ...
  $('.editMessenger-link').on('click', function(e) {
    ...
    if (find > -1) {
      ...
      $.get("{{ route('getContractormessenger') }}", {
        cmId: separated,
        unique: false
      }, function(objectDrivers) {
        ...
        if (count > 0) {
          for (var i = 0; i < count; i++) {
            $('.tbl-drivers-editMessenger').find('tbody').append(
              ...
              "<td>" +
              "<button type='button' class='btn btn-outline-tertiary form-control-sm btn-deleteDriver-editMessenger'><i class='fas fa-trash-alt'></i></button>" +
              "</td>" +
              "</tr>"
            );
          }
      ...
      $.get("{{ route('getContractormessenger') }}", {
        cmId: aumContractormessengers,
        unique: true
      }, function(objectDriver) {
