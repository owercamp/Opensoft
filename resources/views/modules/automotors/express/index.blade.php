...
<div class="col-md-12 p-3">
  <div class="row border-bottom mb-3">
    ...
    <div class="col-md-4">
      <button type="button" title="Registrar carga express automotor" class="btn btn-outline-success form-control-sm newCharge-link">NUEVO</button>
    </div>
    <div class="col-md-4">
  ...
  <table id="tableDatatable" class="table table-hover text-center" width="100%">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <a href="#" title="Editar carga express automotor" class="btn btn-outline-primary rounded-circle form-control-sm editCharge-link">
          ...
          <a href="#" title="Eliminar carga express automotor" class="btn btn-outline-tertiary rounded-circle form-control-sm deleteCharge-link">
      ...
      <div class="modal-body">
        <form action="{{ route('automotors.express.save') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-md-12">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4 text-center">
                      <button type="button" class="btn btn-outline-success form-control-sm mt-3 btn-addDriver-newCharge" title='AGREGUE CONDUCTOR OPERADOR'>Agregar conductor</button>
                    </div>
          ...
          <div class="form-group text-center">
            ...
            <button type="submit" class="btn btn-outline-success form-control-sm btn-newDefinitiveCharge">REGISTRAR AUTOMOTOR</button>
          </div>
        </form>
      </div>
    </div>
        ...
        <form action="{{ route('automotors.express.update') }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="row m-2 p-2 border">
                <div class="col-md-12">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4 text-center">
                      <button type="button" class="btn btn-outline-success form-control-sm mt-3 btn-addDriver-editCharge" title='AGREGUE CONDUCTOR OPERADOR'>Agregar conductor</button>
                    </div>
                    <div class="col-md-4 p-3 text-center">
          ...
          <div class="row border-top mt-3 text-center">
            <div class="col-md-6">
              ...
              <button type="submit" class="btn btn-outline-success form-control-sm my-3 btn-editDefinitiveCharge">GUARDAR CAMBIOS</button>
            </div>
            <div class="col-md-6">
    ...
    if (cmId != '') {
      ...
      if (validateRepet == false) {
        $('.tbl-drivers-newCharge').find('tbody').append(
          ...
          "<td>" +
          "<button type='button' class='btn btn-outline-tertiary form-control-sm btn-deleteDriver-newCharge'><i class='fas fa-trash-alt'></i></button>" +
          "</td>" +
          "</tr>"
        );
      } else {
        ...
        if (count > 0) {
          for (var i = 0; i < count; i++) {
            $('.tbl-drivers-editCharge').find('tbody').append(
              ...
              "<td>" +
              "<button type='button' class='btn btn-outline-tertiary form-control-sm btn-deleteDriver-editCharge'><i class='fas fa-trash-alt'></i></button>" +
              "</td>" +
              "</tr>"
            );
          }
