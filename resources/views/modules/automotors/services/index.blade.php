...
<div class="col-md-12 p-3">
  <div class="row border-bottom mb-3">
    ...
    <div class="col-md-4">
      <button type="button" title="Registrar servicio especial automotor" class="btn btn-outline-success form-control-sm newEspecial-link">NUEVO</button>
    </div>
    <div class="col-md-4">
  ...
  <table id="tableDatatable" class="table table-hover text-center" width="100%">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <a href="#" title="Editar servicio automotor" class="btn btn-outline-primary rounded-circle form-control-sm editEspecial-link">
          ...
          <a href="#" title="Eliminar servicio automotor" class="btn btn-outline-tertiary rounded-circle form-control-sm deleteEspecial-link">
      ...
      <div class="modal-body">
        <form action="{{ route('automotors.services.save') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-md-12">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4 text-center">
                      <button type="button" class="btn btn-outline-success form-control-sm mt-3 btn-addDriver-newEspecial" title='AGREGUE CONDUCTOR OPERADOR'>Agregar conductor</button>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <table class="table table-hover text-center tbl-drivers-newEspecial" width="100%" style="font-size: 12px;">
                        <thead>
                          <th>NOMBRE</th>
                          <th>DOCUMENTO</th>
                          <th>LICENCIA</th>
          ...
          <div class="form-group text-center">
            ...
            <button type="submit" class="btn btn-outline-success form-control-sm btn-newDefinitiveEspecial">REGISTRAR SERVICIO ESPECIAL</button>
          </div>
        </form>
      </div>
    </div>
        ...
        <form action="{{ route('automotors.services.update') }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="row m-2 p-2 border">
                <div class="col-md-12">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4 text-center">
                      <button type="button" class="btn btn-outline-success form-control-sm mt-3 btn-addDriver-editEspecial" title='AGREGUE CONDUCTOR OPERADOR'>Agregar conductor</button>
                    </div>
                    <div class="col-md-4 p-3 text-center">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <table class="table table-hover text-center tbl-drivers-editEspecial" width="100%" style="font-size: 12px;">
                        <thead>
                          <th>NOMBRE</th>
                          <th>DOCUMENTO</th>
                          <th>LICENCIA</th>
          ...
          <div class="row border-top mt-3 text-center">
            <div class="col-md-6">
              ...
              <button type="submit" class="btn btn-outline-success form-control-sm my-3 btn-editDefinitiveEspecial">GUARDAR CAMBIOS</button>
            </div>
            <div class="col-md-6">
...
<script>
    ...
    if (ceId != '') {
      ...
      if (validateRepet == false) {
        $('.tbl-drivers-newEspecial').find('tbody').append(
          ...
          "<td>" +
          "<button type='button' class='btn btn-outline-tertiary form-control-sm btn-deleteDriver-newEspecial'><i class='fas fa-trash-alt'></i></button>" +
          "</td>" +
          "</tr>"
        );
      } else {
  ...
  $('.editEspecial-link').on('click', function(e) {
    ...
    if (find > -1) {
      ...
      $.get("{{ route('getContractorespecial') }}", {
        ceId: separated,
        unique: false
        ...
        if (count > 0) {
          for (var i = 0; i < count; i++) {
            $('.tbl-drivers-editEspecial').find('tbody').append(
              ...
              "<td>" +
              "<button type='button' class='btn btn-outline-tertiary form-control-sm btn-deleteDriver-editEspecial'><i class='fas fa-trash-alt'></i></button>" +
              "</td>" +
              "</tr>"
            );
          }
