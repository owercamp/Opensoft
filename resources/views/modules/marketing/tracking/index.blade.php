  ...
  <table id="tableDatatable" class="table table-hover text-center" width="100%">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <a href="#" title="Bitacora de seguimiento" class="btn btn-outline-primary rounded-circle form-control-sm binnacleOpportunity-link">
          ...
          <!-- <a href="#" title="Editar" class="btn btn-outline-primary form-control-sm editExpress-link">
						...
						<a href="#" title="Eliminar" class="btn btn-outline-tertiary form-control-sm deleteExpress-link">
