...
// !RUTAS DEL MODULO BASE DE DATOS
Route::group(['middleware' => ['role:ADMINISTRADOR SISTEMA|ADMINISTRADOR']], function () {

  // ?BASE DE DATOS >> CONFIGURACION DE EMPRESA
  ...
  // ?BASE DE DATOS >> CONFIGURACION RECURSOS HUMANOS
  ...
  // ?BASE DE DATOS >> CONFIGURACION EMPRESAS ALIADAS
  ...
  // ?BASE DE DATOS >> CONFIGURACION PARQUE AUTOMOTOR
...
Route::group(['middleware' => ['role:ADMINISTRADOR SISTEMA|ADMINISTRADOR']], function () {
  ...
  Route::post('/managerial/document/matrix-epp/save', 'DocumentsManagementController@matrixsave')->name('matriz.save');
  Route::patch('/managerial/document/matrix-epp/update', 'DocumentsManagementController@matrixupdate')->name('matriz.update');
  Route::delete('/managerial/document/matrix-epp/delete', 'DocumentsManagementController@matrixdelete')->name('matriz.delete');
  Route::post('/managerial/document/matrix-epp/PDF', 'DocumentsManagementController@matrixpdf')->name('PDFepp');
...
Route::group(['middleware' => ['role:ADMINISTRADOR SISTEMA|ADMINISTRADOR']], function () {
  ...
  Route::name('tracking')->group(function () {  
    ...
    Route::post('/operative/tracking/binnacle', 'TrackingController@binnacleIndex')->name('.binnacle');
    ...
    Route::post('/operative/tracking/novelty', 'TrackingController@NoveltyReport')->name('.novelty');
