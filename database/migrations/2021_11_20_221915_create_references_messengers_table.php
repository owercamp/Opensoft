...
class CreateReferencesMessengersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('references_messengers', function (Blueprint $table) {
          $table->Increments('rc_id');
          $table->integer('rc_collaborator_id')->unsigned()->comment('se relaciona con el id del colaborador de la tabla Contractorsmessenger');
          ...
          $table->foreign('rc_collaborator_id')->references('cmId')->on('contractorsmessenger');
          $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('references_messengers');
    }
}
