...
class CreateReferencesSpecialsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('references_specials', function (Blueprint $table) {
          $table->Increments('rc_id');
          $table->integer('rc_collaborator_id')->unsigned()->comment('se relaciona con el id del colaborador de la tabla Contractorsserviceespecial');
          ...
          $table->foreign('rc_collaborator_id')->references('ceId')->on('contractorsserviceespecial');
          $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('references_specials');
    }
}
